...
public class MyListener implements ServletContextListener {
    ...
    public void contextDestroyed(ServletContextEvent sce)  { // 웹 서비스가 종료될 때 (톰캣에서 프로젝트가 제거될 때) 
    ...
    public void contextInitialized(ServletContextEvent sce)  { // 웹 서비스가 시작되었을 때 (톰캣에 프로젝트가 올라갈 때)
