...
public class MemberDAO {
	...
	private static DataSource dataSource; // 커넥션풀 관리하는 객체(dataSource)
	// static 필드의 초기화 : static 블록에서 처리
	// 커넥션풀 환경을 읽어오기 위한 static 처리 (context.xml)
	static {
		try {
	...
	public MemberDTO login(MemberDTO dto) {
		...
		try {
			...
			con = dataSource.getConnection(); // Connection을 가지고 있는 dataSource로 부터 con을 가져온다.
