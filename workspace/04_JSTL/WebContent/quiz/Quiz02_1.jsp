...
<body>
	<form action="Quiz02_2.jsp">
		...
		최대 크기<input type="number" min="1" max="7" name="max"><br><br>
		<h3>향상 forEach 연습</h3>		
		...
		<label><input type="checkbox" name="foods" value="짜장면">짜장면</label>
		<label><input type="checkbox" name="foods" value="해장국">해장국</label><br><br>
		<button>전송</button>
