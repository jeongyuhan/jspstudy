...
<body>
	...
	<%-- VIEW : view는 언제나 Servlet(Controller)에게 요청한다. --%>
	...
	<a href="/05_MVC/AgeController?age=20">맥주 하나 주세요!</a>
	...
	<script>
		const form = document.getElementById('f'); // JQuery를 활용할 경우 const form = ${'#f'};
