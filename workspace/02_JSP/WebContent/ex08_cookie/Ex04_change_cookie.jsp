...
<body>
	...
	<%--
		...
		3. 같은 쿠키이름을 가진 새로운 쿠키를 만들어서 덮어쓰기한다.
		   (쿠키를 변경하는 과정은 addCookie를 하여 덮어쓰는 과정으로 한다.)   
	 --%>
	 ...
	 <% 
	 	...
	 	if(cookies != null && cookies.length != 0) {
	 		for(Cookie cookie : cookies) {
	 			if(cookie.getName().equals("name")) { // 받아온 쿠키의 name과 새로만든 ck의 name이 같은 경우
	 				response.addCookie(ck); // 덮어쓰는 과정
	 			}
  	 		}
	 	}
	 	...
	 	if(cookies2 != null && cookies.length != 0) {
